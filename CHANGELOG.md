...
- Added [Karma Problem Matcher](https://marketplace.visualstudio.com/items?itemName=rctay.karma-problem-matcher)
- Changed extensionDependencies for extensionPack in package.json
- Removed obsolete [Path-intellisense] extension
- Updated vscode engine to 1.26
